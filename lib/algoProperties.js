...
sha1: {
    ...
    whirlcoin: {
        hash: function(){
            return function(){
                return multiHashing.whirlcoin.apply(this, arguments);
            }
        }
    },
    whirlpool: {
    ...
    stack: {
        hash: function(){
            return function(){
                return multiHashing.stack.apply(this, arguments);
            }
        }
    },
    keccak: {
    ...
    skein2: {
        hash: function(){
            return function(){
                return multiHashing.skein2.apply(this, arguments);
            }
        }
    },
    groestl: {
    ...
    goal: {
        hash: function(){
            return function(){
                return multiHashing.goal.apply(this, arguments);
            }
        }
    },
    shavite3: {
    ...
    pentablake: {
        hash: function(){
            return function(){
                return multiHashing.pentablake.apply(this, arguments);
            }
        }
    },
    bastion: {
        hash: function(){
            return function(){
                return multiHashing.bastion.apply(this, arguments);
            }
        }
    },
    axiom: {
        hash: function(){
            return function(){
                return multiHashing.axiom.apply(this, arguments);
            }
        }
    },
    shabal: {
        hash: function(){
            return function(){
                return multiHashing.shabal.apply(this, arguments);
            }
        }
    },
    qubit: {
